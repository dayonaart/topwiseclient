...
class VisaParameter implements Serializable, EmvParameter {
    ...
    public String pack() throws EmvParameterException {
        ...
        if (this.rcp != null) {
            ...
            tlvList.addTLV(EMVTag.V_TAG_RD_RCP, this.rcp);
        }
        ...
        tlvList.addTLV(EMVTag.V_TAG_TM_9F66, this.transactionProperties);
        ...
        if (this.rfTransactionLimit != null) {
            ...
            tlvList.addTLV(EMVTag.V_TAG_TM_TRANS_LIMIT, BytesUtil.toBCDAmountBytes(this.rfTransactionLimit));
        }
        ...
        if (this.rfCvmLimit != null) {
            ...
            tlvList.addTLV(EMVTag.V_TAG_TM_CVM_LIMIT, BytesUtil.toBCDAmountBytes(this.rfCvmLimit));
        }
        ...
        if (this.rfFloorLimit != null) {
            ...
            tlvList.addTLV(EMVTag.V_TAG_TM_FLOOR_LIMIT, BytesUtil.toBCDAmountBytes(this.rfFloorLimit));
        }
