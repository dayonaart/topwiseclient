...
class AmexParameter implements Serializable, EmvParameter {
    ...
    public String pack() throws EmvParameterException {
        ...
        tlvList.addTLV(EMVTag.A_TAG_TM_9F6D, new byte[]{this.rfReaderCapabilities.byteValue()});
        ...
        tlvList.addTLV(EMVTag.A_TAG_TM_9F6E, this.enhancedRfReaderCapabilities);

        if (this.tryAgain == null) {
            throw new EmvParameterException("Please set whether to try again or not.");
        }
        tlvList.addTLV(EMVTag.A_TAG_PREAGAIN, new byte[]{(byte) (this.tryAgain ? 1 : 0)});
        ...
        if (this.rfTransactionLimit != null) {
            ...
            tlvList.addTLV(EMVTag.A_TAG_TM_TRANS_LIMIT, BytesUtil.toBCDAmountBytes(this.rfTransactionLimit));
        }
        ...
        if (this.rfCvmLimit != null) {
            ...
            tlvList.addTLV(EMVTag.A_TAG_TM_CVM_LIMIT, BytesUtil.toBCDAmountBytes(this.rfCvmLimit));
        }
        ...
        if (this.rfFloorLimit != null) {
            ...
            tlvList.addTLV(EMVTag.A_TAG_TM_FLOOR_LIMIT, BytesUtil.toBCDAmountBytes(this.rfFloorLimit));
        }
