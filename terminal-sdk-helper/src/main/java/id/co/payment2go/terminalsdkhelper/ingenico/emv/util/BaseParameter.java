...
//        this.onlineTac = new byte[]{0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    public String pack() throws EmvParameterException {
        ...
        tlvList.addTLV(EMVTag.EMV_TAG_TM_TERMTYPE, new byte[]{this.terminalType});
        ...
        tlvList.addTLV(EMVTag.EMV_TAG_TM_CAP, this.terminalCapabilities);
        ...
        tlvList.addTLV(EMVTag.EMV_TAG_TM_CAP_AD, this.additionalTerminalCapabilities);

        if (this.countryCode == null || this.countryCode.length != 2) {
            throw new EmvParameterException("Country code should be a buffer of length 2.");
        }
        tlvList.addTLV(EMVTag.EMV_TAG_TM_CNTRYCODE, this.countryCode);
        ...
        tlvList.addTLV(EMVTag.EMV_TAG_TM_CURCODE, this.currencyCode);
        ...
        if (this.floorLimit != null) {
            ...
            tlvList.addTLV(EMVTag.EMV_TAG_TM_FLOORLMT, BytesUtil.toFourByteArray(this.floorLimit));
        }
        ...
        tlvList.addTLV(EMVTag.DEF_TAG_RAND_SLT_THRESHOLD, BytesUtil.toBCDAmountBytes(this.randomSelectionThreshold));
        ...
        tlvList.addTLV(EMVTag.DEF_TAG_RAND_SLT_PER, new byte[]{this.randomSelectionPercentage});
        ...
        tlvList.addTLV(EMVTag.DEF_TAG_RAND_SLT_MAXPER, new byte[]{this.maxRandomSelectionPercentage});

        // Optional
        if (this.ddol != null) {
            tlvList.addTLV(EMVTag.DEF_TAG_DOL_DEFAULT_DDOL, this.ddol);
        }

        // Optional
        if (this.tdol != null) {
            tlvList.addTLV(EMVTag.DEF_TAG_DOL_DEFAULT_TDOL, this.tdol);
        }

        // Optional
        if (this.udol != null) {
            tlvList.addTLV(EMVTag.DEF_TAG_DOL_DEFAULT_UDOL, this.udol);
        }

        // Optional
        if (this.otherParameters != null) {
            byte[] tempBuf = BytesUtil.merge(tlvList.toBinary(), this.otherParameters.toBinary());
            return BytesUtil.byteArray2HexString(tempBuf);
        }
