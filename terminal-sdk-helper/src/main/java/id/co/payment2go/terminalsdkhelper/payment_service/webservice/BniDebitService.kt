...
import id.co.payment2go.terminalsdkhelper.check_balance.data.model.CardCheckBalanceDto
...
interface BniDebitService {
    ...
    suspend fun postCardPayment(@Body cardPayment: CardPaymentDto): JsonObject
    ...
    suspend fun checkBalance(@Body cardCheckBalance: CardCheckBalanceDto): JsonObject
